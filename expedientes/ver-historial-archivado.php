...
$_SESSION['idexpediente'];
?>

<body>
  <div class="container-fluid">
     <span class="subtituloMenu">HISTORIAL DE EXPEDIENTE ARCHIVADO N° <?php echo $identificador ?></span><br><br>
...
function mostrarHistorial($identificador){
  ...
  ?>
    <a href="detalles-expediente-archivado.php?id=<?php echo $_SESSION['idexpediente']; ?>" class="btn" id="botonVolver">Volver</a>
