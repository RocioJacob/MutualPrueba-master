...
<body>
  <div class="container" id="mycontainer">
    <span class="subtituloMenu">BÚSQUEDA DE EXPEDIENTES</span><br>
     <input type="text" name="busqueda" id="busqueda" placeholder=" Ingresar ID o tipo o tramite o documento o cuit o código" maxlength="15" autocomplete="off"><br>
