...
if (isset($_POST["id"])) {
    ...
    $sql = "UPDATE expedientes SET oculto = '0' WHERE id = ?";
    ...
    if(mysqli_stmt_affected_rows($stmt) > 0){
        echo json_encode(array('mensaje' => "Expediente ocultado", 'salida' => '0'));
    } 
    else{
        echo json_encode(array('mensaje' => "Error al ocultar expediente ".mysqli_error($conexion), 'salida' => '1'));
    }
